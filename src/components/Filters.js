...
const Filters = () => {
  const {filters:{
    text,category,company,color,min_price,max_price,price,shipping},updateFilters,clearFilters,all_products 
  } = useFilterContext()
          ...
          <div className="colors">
            {
              colors.map((c,index)=>{
                ...
                if(c==='all'){
                  return <button name="color" onClick={updateFilters} key={index} data-color="all" className={
